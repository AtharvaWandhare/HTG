...
router
  .route("/update-rating/:serviceProviderId")
  .patch(verifyJWT, updateServiceProviderRating) // To update the rating in the database
  .get(verifyJWT, getServiceProviderRating);
